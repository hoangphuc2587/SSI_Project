...
<head>
    ...
    <script src='https://www.google.com/recaptcha/api.js?hl=ja&render=6LfG38wZAAAAADNtbQiLE7dbAy3KSVV6ja3frZBH'></script>
...
<!--                                    </tr>-->
                            ...
                            <div class="list-btn">
                                ...
                                <p class="btn-wrapper " id="wrapperSendMail">
    ...
    <script>
        grecaptcha.ready(function() {
            grecaptcha.execute('6LfG38wZAAAAADNtbQiLE7dbAy3KSVV6ja3frZBH', {action: 'contact'})
                .then(function(token) {
                    console.log(token);
