...
<head>
    ...
    <meta charset="utf-8">
    <title>エラー｜株式会社ソフトウエア・サイエンス（SSI）</title>
    <!--seo-->
...
<body>
    ...
    <div class="container container_mb">
        <div class="error_wrap">
            <p class="notice_404">
               <b>お探しのページは見つかりませんでした。</b>
            </p>

            <p>このページは、一時的にアクセスできない状況にあるか、別の場所に移動した可能性がございます。</p>
            <p>ご不便をおかけいたしますが、URLをご確認いただくか、トップページからアクセスしてください。</p>
            <div class="wrap_btn">
                <div class="btn-al">
                    <a href="/" alt="トップページ">
