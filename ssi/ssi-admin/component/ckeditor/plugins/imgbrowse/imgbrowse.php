...
class imgbrowse {
  // IN $root - REPLACE "SmartySample/demo/image" WITH THE PATH TO THE FOLDER WITH IMAGES RELATIVE TO ROOT OF YOUR WEBSITE ON SERVER
  protected $root = 'vop/src/images/news';
